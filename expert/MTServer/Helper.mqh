   ...
   switch(error_code)
     {
      ...
      case 4002:
         ...
         break;
      case 4003:
         error_string="memory for function call stack";
         break;
      case 4004:
      ...
      case 4005:
         ...
         break;
      case 4006:
         error_string="memory for parameter string";
         break;
      case 4007:
         error_string="memory for temp string";
         break;
      case 4008:
      ...
      case 4009:
         ...
         break;
      case 4010:
         error_string="memory for array string";
         break;
      case 4011:
      ...
      case 4072:
         ...
         break;
      case 4073:
         error_string="history data";
         break;
      case 4074:
         error_string="memory for history data";
         break;
      case 4075:
         error_string="Not enough memory for indicator calculation";
         break;
      case 4099:
      ...
      case 4205:
         ...
         break;
      case 4206:
         error_string="specified subwindow";
         break;
      case 4207:
      ...
      case 4261:
         ...
         break;
      case 4262:
         error_string="FTP connection failed";
         break;
      case 4263:
         error_string="FTP connection closed";
         break;
      case 4264:
         error_string="FTP path not found on server";
         break;
      case 4265:
         error_string="File not found in the MQL4\\Files directory to send on FTP server";
         break;
      case 4266:
         error_string="Common error during FTP data transmission";
         break;
      case 5001:
         error_string="Too many opened files";
         break;
